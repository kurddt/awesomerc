...
--beautiful.init("/home/guillaume/.config/awesome/themes/conscience/theme.lua")
...
--        end),
  ...
  --  awful.key({ modkey,           }, "u", awful.client.urgent.jumpto),
	...
	awful.key({ modkey,  }, "e", function () awful.util.spawn("/work1/glager/eclipse/eclipse") end),
